...
const CheckoutPage = () => {
  ...
  const shipping = subtotal > 10000 ? 0 : 200; // NPR shipping
  ...
  const handleKhaltiPayment = async () => {
    ...
    try {
      ...
      if (paymentResult.success) {
        // In real implementation, this would redirect to Khalti checkout
  ...
  const handleCheckout = async (e) => {
    ...
    if (!phoneRegex.test(formData.phone)) {
      alert('Please enter a valid Nepal phone number (98xxxxxxxx or 97xxxxxxxx)');
      return;
    }
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Choose how to pay (Nepal)</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-400">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Pay with cash when you receive</p>
                  </div>
                ...
                <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-400">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Pay via Khalti Wallet</p>
                  </div>
                  <div className="ml-auto">
                ...
                {formData.paymentMethod === 'khalti' && (
                  <div className="mt-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="font-medium text-purple-900 mb-1">Secure Khalti Payment</p>
                ...
                {formData.paymentMethod === 'cod' && (
                  <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="font-medium text-yellow-900 mb-1">Cash on Delivery</p>
                ...
                {formData.paymentMethod === 'bank_transfer' && (
                  <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="font-medium text-green-900 mb-1">Bank Transfer Instructions</p>
                        <ul className="text-sm text-green-800 space-y-1">
                          ...
                          <li>• Order processed after payment verification</li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="pt-4 border-t border-gray-200 flex justify-between text-lg font-bold">
                  ...
                  <span className="text-blue-600">
                    NPR {(formData.paymentMethod === 'cod' && total < 20000 ? total + 100 : total).toLocaleString()}
                  </span>
                </div>
              </div>
              ...
              <div className="mb-6 p-4 bg-green-50 rounded-lg border border-green-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-green-900">Delivery Information</p>
                    <p className="text-sm text-green-800">
                      • 3-7 business days delivery<br />
                      • Free shipping on orders above NPR 10,000<br />
                ...
                <div className="mb-6 p-6 bg-blue-50 rounded-xl border-2 border-blue-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center">
                        <code className="bg-white px-3 py-1 rounded border">{orderCreated._id}</code>
                        <button
                          onClick={() => copyToClipboard(orderCreated._id, 'orderId')}
                          className="ml-2 p-1 hover:bg-blue-100 rounded"
                        >
                          {copied.orderId ? <Check className="w-4 h-4 text-green-600" /> : <Copy className="w-4 h-4 text-gray-500" />}
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-blue-700">NPR {total}</span>
                    </div>
                          ...
                          key !== 'qrImage' && (
                            <div key={key} className="flex justify-between">
                              ...
                              <div className="flex items-center">
                                ...
                                >
                                  {copied[key] ? <Check className="w-3 h-3 text-green-600" /> : <Copy className="w-3 h-3 text-gray-400" />}
                                </button>
                              </div>
                            </div>
                          )
                    ...
                    {showQRCode && (
                      <div className="mt-4 p-4 bg-white rounded-lg border text-center">
                        <h4 className="font-medium text-gray-900 mb-3">Scan to Pay</h4>
                    ...
                    <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                      <p className="text-sm text-yellow-800">
                        <strong>Important:</strong> After payment, please send the transaction screenshot to 
                        WhatsApp: +977-9800000000 with your Order ID.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      Place Order • NPR {(formData.paymentMethod === 'cod' && total < 20000 ? total + 100 : total).toLocaleString()}
                    </>
                  )}
                </button>
